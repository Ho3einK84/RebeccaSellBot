...
export const EN_TEXTS: Record<string, string> = {
  ...
  admin_settings_subtitle:
    'Manage product, payment, lifecycle, and naming settings without leaving Telegram.',
  admin_package_manager_title: 'Package Manager',
  admin_package_manager_subtitle:
    'Edit the catalogue customers see before purchase. At least one package must remain available.',
  admin_setting_saved_title: 'Setting Saved',
  admin_package_saved_title: 'Package Catalogue Saved',
  ...
  admin_setting_group_support_desc: 'Configure bot support account username or Telegram ID',
