...
export const SETTING_DEFINITIONS: readonly SettingDefinition[] = [
  ...
  {
    key: 'receipt_notify_enabled',
    group: 'payment',
    labelKey: 'admin_setting_receipt_notify_enabled',
    editor: { type: 'boolean' },
  },
  {
    key: 'receipt_notify_mode',
    group: 'payment',
    labelKey: 'admin_setting_receipt_notify_mode',
    editor: { type: 'text', minimumLength: 4, maximumLength: 10 },
  },
  {
    key: 'receipt_notify_admins',
    group: 'payment',
    labelKey: 'admin_setting_receipt_notify_admins',
    editor: { type: 'text', minimumLength: 0, maximumLength: 500 },
  },
  {
