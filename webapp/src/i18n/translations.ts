...
export const translations: Record<SupportedLocale, Translations> = {
  fa: {
    ...
    greeting: 'سلام، {name}!',
    telegramId: 'شناسه:',
    portalTitle: 'مینی‌اپ کاربری به‌زودی',
    portalDesc:
      'خرید و تمدید اشتراک، مشاهده حجم مصرفی، دریافت کانفیگ و شارژ کیف پول به‌زودی از طریق مینی‌اپ در دسترس خواهد بود.',
  ...
  en: {
    ...
    greeting: 'Hello, {name}!',
    telegramId: 'ID:',
    portalTitle: 'User Mini App Coming Soon',
    portalDesc:
      'Buy subscriptions, track bandwidth, get connection configs, and manage your wallet directly in the Mini App soon.',
