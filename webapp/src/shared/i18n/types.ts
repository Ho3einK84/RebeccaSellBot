...
export interface TranslationSchema {
  ...
  admin: {
    ...
    receipts: {
      ...
      batchApproveTitle: string;
      batchApproveConfirmBody: string;
      batchApproveConfirmBtn: string;
      batchApproveSuccess: string;
      settingsBtn: string;
      settingsModalTitle: string;
      settingsNotifyEnabled: string;
      settingsNotifyEnabledDesc: string;
      settingsModeTitle: string;
      settingsModeFullTitle: string;
      settingsModeFull: string;
      settingsModeSimpleTitle: string;
      settingsModeSimple: string;
      settingsAdminsTitle: string;
      settingsAdminsAll: string;
      settingsAdminsCustom: string;
    ...
    users: {
      ...
      configPanel: string;
      configTraffic: string;
      configTrafficUnlimited: string;
      configExpire: string;
      configExpireUnlimited: string;
      configExpireDaysLeft: string;
      configExpired: string;
      btnShowQr: string;
      qrModalTitle: string;
      subUrlLabel: string;
      noSubUrl: string;
      btnToggleDisable: string;
      btnToggleEnable: string;
      btnResetTraffic: string;
      btnRevokeSub: string;
      btnSync: string;
      resetTrafficConfirmTitle: string;
      resetTrafficConfirmDesc: string;
    ...
    panels: {
      ...
      offline: string;
      configsCount: string;
      configsCountLabel: string;
      packagesCountLabel: string;
      servicesCountLabel: string;
      noServices: string;
      fleetStatusOk: string;
      fleetStatusWarning: string;
      fleetMetricHealthy: string;
      fleetMetricIssues: string;
      fleetMetricConfigs: string;
      fleetMetricServices: string;
      filterAll: string;
      filterOnline: string;
      filterIssues: string;
      addPanelBtn: string;
      ...
      disableBtn: string;
      enableBtn: string;
      makeDefaultBtn: string;
      deleteBtn: string;
      customTargetBadge: string;
      addModalTitle: string;
      editModalTitle: string;
      manageServicesTitle: string;
      ...
      makeDefaultServiceBtn: string;
      setCustomTargetBtn: string;
      deleteConfirmPrompt: string;
      deleteWarningTitle: string;
      deleteWarningDesc: string;
      confirmDeleteBtn: string;
      validationNameRequired: string;
      validationUrlRequired: string;
      validationUrlScheme: string;
      validationServiceId: string;
      validationServiceName: string;
      testAllSuccessNotify: string;
      createSuccessNotify: string;
      updateSuccessNotify: string;
      enableSuccessNotify: string;
      disableSuccessNotify: string;
      setDefaultSuccessNotify: string;
      deleteSuccessNotify: string;
      addServiceSuccessNotify: string;
      setDefaultServiceSuccessNotify: string;
      setCustomTargetSuccessNotify: string;
      deleteServiceSuccessNotify: string;
    };
    modules: {
      title: string;
      desc: string;
