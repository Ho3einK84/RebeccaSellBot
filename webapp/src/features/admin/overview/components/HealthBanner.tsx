...
export const HealthBanner: React.FC<HealthBannerProps> = ({ panelHealth, onSwitchToPanels }) => {
  ...
  return (
    <div
      className={`rounded-2xl p-4 flex items-center justify-between cursor-pointer border transition-all duration-200 active:scale-[0.99] hover:border-slate-300 dark:hover:border-white/20 ${cardClass}`}
    ...
    >
      ...
      <div
        className={`text-xs font-medium px-2.5 py-1 rounded-xl border ${
          isDark
