...
export function useAdminPanels() {
  ...
  return {
    ...
    testingPanelId,
    togglingPanelId:
      (togglePanelMutation.variables as { panelId: string } | undefined)?.panelId ?? null,
    settingDefaultPanelId: (setDefaultPanelMutation.variables as string | undefined) ?? null,
